        ...
        <div class="col-md-12 text-center">
            <div class="block wow fadeInUp" data-wow-delay=".3s">
                ...
                <section class="cd-intro">
                    ...
                    <span>UKM BELA DIRI PSHT</span><br>
                    <span class="cd-words-wrapper">
                        <b class="is-visible">IAIN</b>
                        <b>PONOROGO</b>
                    </span>
                    </h1>
                    </section> <!-- cd-intro -->
                    ...
                    <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
                      <b> Jl. Pramuka No. 56 Ponorogo<br></b>
                    </h2>
                    <a class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green" data-wow-delay=".9s" href="#works" data-section="#works">MULAI</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
                   ...
                   Tentang UKM
                    ...
                    <p>
                       Unit Kegiatan Mahasiswa yang bergerak di bidang olah raga yaitu bela diri pencak silat PSHT.
                    </p>
                    <p>
                       Yang berlokasi di IAIN Ponorogo.
                    </p>
                </div>
