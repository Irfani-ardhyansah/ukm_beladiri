  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('/admin/anggota/edit/' . $row->id_anggota) }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
        ...
        <div class="col-xs-6">
          <div class="form-group">
            <label for="foto">Foto Anggota</label>
              <div class="input-group">
                <div class="custom-file">
                <img id="file_preview" class="profile-user-img img-responsive pull-left" style="height: 150px; width: 150px; display: block;">
                  <input name="file" type="file"  id="file">
                  @if ($errors->has('file'))
                    <div class="alert alert-danger">Terjadi Kesalahan Saat Upload!</div>
                  @endif
